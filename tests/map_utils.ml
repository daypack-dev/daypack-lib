...
Daypack_lib.Task_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Task_id_map_utils.add_diff diff old) x
)
...
Daypack_lib.Task_inst_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Task_inst_id_map_utils.add_diff diff old) x
)
...
Daypack_lib.Task_seg_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Task_seg_id_map_utils.add_diff diff old) x
)
...
Daypack_lib.Sched_req_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Sched_req_id_map_utils.add_diff diff old) x
)
...
(fun (old, x) -> 
let diff = Daypack_lib.Task_id_map_utils.diff ~old x in
Daypack_lib.Task_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Task_id_map_utils.sub_diff diff x) old
)
...
(fun (old, x) -> 
let diff = Daypack_lib.Task_inst_id_map_utils.diff ~old x in
Daypack_lib.Task_inst_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Task_inst_id_map_utils.sub_diff diff x) old
)
...
(fun (old, x) -> 
let diff = Daypack_lib.Task_seg_id_map_utils.diff ~old x in
Daypack_lib.Task_seg_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Task_seg_id_map_utils.sub_diff diff x) old
)
...
(fun (old, x) -> 
let diff = Daypack_lib.Sched_req_id_map_utils.diff ~old x in
Daypack_lib.Sched_req_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Sched_req_id_map_utils.sub_diff diff x) old
)
...
QCheck.Test.make ~count:5000 ~name:"qc_sub_diff_is_inverse_of_add_diff_test_task_store"
QCheck.(pair task_store task_store)
(fun (old, x) -> 
let diff = Daypack_lib.Task_id_map_utils.diff ~old x in
Daypack_lib.Task_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Task_id_map_utils.sub_diff diff (Daypack_lib.Task_id_map_utils.add_diff diff old)) old
)
let qc_sub_diff_is_inverse_of_add_diff_test_task_inst_store =
QCheck.Test.make ~count:5000 ~name:"qc_sub_diff_is_inverse_of_add_diff_test_task_inst_store"
QCheck.(pair task_inst_store task_inst_store)
(fun (old, x) -> 
let diff = Daypack_lib.Task_inst_id_map_utils.diff ~old x in
Daypack_lib.Task_inst_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Task_inst_id_map_utils.sub_diff diff (Daypack_lib.Task_inst_id_map_utils.add_diff diff old)) old
)
let qc_sub_diff_is_inverse_of_add_diff_test_task_seg_store =
QCheck.Test.make ~count:5000 ~name:"qc_sub_diff_is_inverse_of_add_diff_test_task_seg_store"
QCheck.(pair task_seg_store task_seg_store)
(fun (old, x) -> 
let diff = Daypack_lib.Task_seg_id_map_utils.diff ~old x in
Daypack_lib.Task_seg_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Task_seg_id_map_utils.sub_diff diff (Daypack_lib.Task_seg_id_map_utils.add_diff diff old)) old
)
let qc_sub_diff_is_inverse_of_add_diff_test_sched_req_pending_store =
QCheck.Test.make ~count:5000 ~name:"qc_sub_diff_is_inverse_of_add_diff_test_sched_req_pending_store"
QCheck.(pair sched_req_store sched_req_store)
(fun (old, x) -> 
let diff = Daypack_lib.Sched_req_id_map_utils.diff ~old x in
Daypack_lib.Sched_req_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Sched_req_id_map_utils.sub_diff diff (Daypack_lib.Sched_req_id_map_utils.add_diff diff old)) old
)
let qc_sub_diff_is_inverse_of_add_diff_test_sched_req_record_store =
QCheck.Test.make ~count:5000 ~name:"qc_sub_diff_is_inverse_of_add_diff_test_sched_req_record_store"
QCheck.(pair sched_req_record_store sched_req_record_store)
(fun (old, x) -> 
let diff = Daypack_lib.Sched_req_id_map_utils.diff ~old x in
Daypack_lib.Sched_req_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Sched_req_id_map_utils.sub_diff diff (Daypack_lib.Sched_req_id_map_utils.add_diff diff old)) old
...
QCheck.Test.make ~count:5000 ~name:"qc_add_diff_is_inverse_of_sub_diff_test_task_store"
QCheck.(pair task_store task_store)
(fun (old, x) -> 
let diff = Daypack_lib.Task_id_map_utils.diff ~old x in
Daypack_lib.Task_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Task_id_map_utils.add_diff diff (Daypack_lib.Task_id_map_utils.sub_diff diff x)) x
)
let qc_add_diff_is_inverse_of_sub_diff_test_task_inst_store =
QCheck.Test.make ~count:5000 ~name:"qc_add_diff_is_inverse_of_sub_diff_test_task_inst_store"
QCheck.(pair task_inst_store task_inst_store)
(fun (old, x) -> 
let diff = Daypack_lib.Task_inst_id_map_utils.diff ~old x in
Daypack_lib.Task_inst_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Task_inst_id_map_utils.add_diff diff (Daypack_lib.Task_inst_id_map_utils.sub_diff diff x)) x
)
let qc_add_diff_is_inverse_of_sub_diff_test_task_seg_store =
QCheck.Test.make ~count:5000 ~name:"qc_add_diff_is_inverse_of_sub_diff_test_task_seg_store"
QCheck.(pair task_seg_store task_seg_store)
(fun (old, x) -> 
let diff = Daypack_lib.Task_seg_id_map_utils.diff ~old x in
Daypack_lib.Task_seg_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Task_seg_id_map_utils.add_diff diff (Daypack_lib.Task_seg_id_map_utils.sub_diff diff x)) x
)
let qc_add_diff_is_inverse_of_sub_diff_test_sched_req_pending_store =
QCheck.Test.make ~count:5000 ~name:"qc_add_diff_is_inverse_of_sub_diff_test_sched_req_pending_store"
QCheck.(pair sched_req_store sched_req_store)
(fun (old, x) -> 
let diff = Daypack_lib.Sched_req_id_map_utils.diff ~old x in
Daypack_lib.Sched_req_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Sched_req_id_map_utils.add_diff diff (Daypack_lib.Sched_req_id_map_utils.sub_diff diff x)) x
)
let qc_add_diff_is_inverse_of_sub_diff_test_sched_req_record_store =
QCheck.Test.make ~count:5000 ~name:"qc_add_diff_is_inverse_of_sub_diff_test_sched_req_record_store"
QCheck.(pair sched_req_record_store sched_req_record_store)
(fun (old, x) -> 
let diff = Daypack_lib.Sched_req_id_map_utils.diff ~old x in
Daypack_lib.Sched_req_id_map.equal (fun x y -> compare x y = 0) (Daypack_lib.Sched_req_id_map_utils.add_diff diff (Daypack_lib.Sched_req_id_map_utils.sub_diff diff x)) x
...
QCheck.Test.make ~count:5000 ~name:"qc_add_diff_bucketed_test_user_id_to_task_ids"
QCheck.(pair user_id_to_task_ids user_id_to_task_ids)
(fun (old, x) -> 
let diff = Daypack_lib.User_id_map_utils.Int64_bucketed.diff_bucketed ~old x in
Daypack_lib.User_id_map.equal Daypack_lib.Int64_set.equal (Daypack_lib.User_id_map_utils.Int64_bucketed.add_diff_bucketed diff old) x
)
let qc_add_diff_bucketed_test_task_id_to_task_inst_ids =
QCheck.Test.make ~count:5000 ~name:"qc_add_diff_bucketed_test_task_id_to_task_inst_ids"
QCheck.(pair task_id_to_task_inst_ids task_id_to_task_inst_ids)
(fun (old, x) -> 
let diff = Daypack_lib.Task_id_map_utils.Int64_bucketed.diff_bucketed ~old x in
Daypack_lib.Task_id_map.equal Daypack_lib.Int64_set.equal (Daypack_lib.Task_id_map_utils.Int64_bucketed.add_diff_bucketed diff old) x
)
let qc_add_diff_bucketed_test_task_inst_id_to_task_seg_ids =
QCheck.Test.make ~count:5000 ~name:"qc_add_diff_bucketed_test_task_inst_id_to_task_seg_ids"
QCheck.(pair task_inst_id_to_task_seg_ids task_inst_id_to_task_seg_ids)
(fun (old, x) -> 
let diff = Daypack_lib.Task_inst_id_map_utils.Int64_bucketed.diff_bucketed ~old x in
Daypack_lib.Task_inst_id_map.equal Daypack_lib.Int64_set.equal (Daypack_lib.Task_inst_id_map_utils.Int64_bucketed.add_diff_bucketed diff old) x
)
let qc_sub_diff_bucketed_test_user_id_to_task_ids =
QCheck.Test.make ~count:5000 ~name:"qc_sub_diff_bucketed_test_user_id_to_task_ids"
QCheck.(pair user_id_to_task_ids user_id_to_task_ids)
(fun (old, x) -> 
let diff = Daypack_lib.User_id_map_utils.Int64_bucketed.diff_bucketed ~old x in
Daypack_lib.User_id_map.equal Daypack_lib.Int64_set.equal (Daypack_lib.User_id_map_utils.Int64_bucketed.sub_diff_bucketed diff x) old
)
let qc_sub_diff_bucketed_test_task_id_to_task_inst_ids =
QCheck.Test.make ~count:5000 ~name:"qc_sub_diff_bucketed_test_task_id_to_task_inst_ids"
QCheck.(pair task_id_to_task_inst_ids task_id_to_task_inst_ids)
(fun (old, x) -> 
let diff = Daypack_lib.Task_id_map_utils.Int64_bucketed.diff_bucketed ~old x in
Daypack_lib.Task_id_map.equal Daypack_lib.Int64_set.equal (Daypack_lib.Task_id_map_utils.Int64_bucketed.sub_diff_bucketed diff x) old
)
let qc_sub_diff_bucketed_test_task_inst_id_to_task_seg_ids =
QCheck.Test.make ~count:5000 ~name:"qc_sub_diff_bucketed_test_task_inst_id_to_task_seg_ids"
QCheck.(pair task_inst_id_to_task_seg_ids task_inst_id_to_task_seg_ids)
(fun (old, x) -> 
let diff = Daypack_lib.Task_inst_id_map_utils.Int64_bucketed.diff_bucketed ~old x in
Daypack_lib.Task_inst_id_map.equal Daypack_lib.Int64_set.equal (Daypack_lib.Task_inst_id_map_utils.Int64_bucketed.sub_diff_bucketed diff x) old
)
let qc_sub_diff_bucketed_is_inverse_of_add_diff_test_bucketed_user_id_to_task_ids =
QCheck.Test.make ~count:5000 ~name:"qc_sub_diff_bucketed_is_inverse_of_add_diff_test_bucketed_user_id_to_task_ids"
QCheck.(pair user_id_to_task_ids user_id_to_task_ids)
(fun (old, x) -> 
let diff = Daypack_lib.User_id_map_utils.Int64_bucketed.diff_bucketed ~old x in
Daypack_lib.User_id_map.equal Daypack_lib.Int64_set.equal (Daypack_lib.User_id_map_utils.Int64_bucketed.sub_diff_bucketed diff (Daypack_lib.User_id_map_utils.Int64_bucketed.add_diff_bucketed diff old)) old
)
let qc_sub_diff_bucketed_is_inverse_of_add_diff_test_bucketed_task_id_to_task_inst_ids =
QCheck.Test.make ~count:5000 ~name:"qc_sub_diff_bucketed_is_inverse_of_add_diff_test_bucketed_task_id_to_task_inst_ids"
QCheck.(pair task_id_to_task_inst_ids task_id_to_task_inst_ids)
(fun (old, x) -> 
let diff = Daypack_lib.Task_id_map_utils.Int64_bucketed.diff_bucketed ~old x in
Daypack_lib.Task_id_map.equal Daypack_lib.Int64_set.equal (Daypack_lib.Task_id_map_utils.Int64_bucketed.sub_diff_bucketed diff (Daypack_lib.Task_id_map_utils.Int64_bucketed.add_diff_bucketed diff old)) old
)
let qc_sub_diff_bucketed_is_inverse_of_add_diff_test_bucketed_task_inst_id_to_task_seg_ids =
QCheck.Test.make ~count:5000 ~name:"qc_sub_diff_bucketed_is_inverse_of_add_diff_test_bucketed_task_inst_id_to_task_seg_ids"
QCheck.(pair task_inst_id_to_task_seg_ids task_inst_id_to_task_seg_ids)
(fun (old, x) -> 
let diff = Daypack_lib.Task_inst_id_map_utils.Int64_bucketed.diff_bucketed ~old x in
Daypack_lib.Task_inst_id_map.equal Daypack_lib.Int64_set.equal (Daypack_lib.Task_inst_id_map_utils.Int64_bucketed.sub_diff_bucketed diff (Daypack_lib.Task_inst_id_map_utils.Int64_bucketed.add_diff_bucketed diff old)) old
)
let qc_add_diff_bucketed_is_inverse_of_sub_diff_test_bucketed_user_id_to_task_ids =
QCheck.Test.make ~count:5000 ~name:"qc_add_diff_bucketed_is_inverse_of_sub_diff_test_bucketed_user_id_to_task_ids"
QCheck.(pair user_id_to_task_ids user_id_to_task_ids)
(fun (old, x) -> 
let diff = Daypack_lib.User_id_map_utils.Int64_bucketed.diff_bucketed ~old x in
Daypack_lib.User_id_map.equal Daypack_lib.Int64_set.equal (Daypack_lib.User_id_map_utils.Int64_bucketed.add_diff_bucketed diff (Daypack_lib.User_id_map_utils.Int64_bucketed.sub_diff_bucketed diff x)) x
)
let qc_add_diff_bucketed_is_inverse_of_sub_diff_test_bucketed_task_id_to_task_inst_ids =
QCheck.Test.make ~count:5000 ~name:"qc_add_diff_bucketed_is_inverse_of_sub_diff_test_bucketed_task_id_to_task_inst_ids"
QCheck.(pair task_id_to_task_inst_ids task_id_to_task_inst_ids)
(fun (old, x) -> 
let diff = Daypack_lib.Task_id_map_utils.Int64_bucketed.diff_bucketed ~old x in
Daypack_lib.Task_id_map.equal Daypack_lib.Int64_set.equal (Daypack_lib.Task_id_map_utils.Int64_bucketed.add_diff_bucketed diff (Daypack_lib.Task_id_map_utils.Int64_bucketed.sub_diff_bucketed diff x)) x
)
let qc_add_diff_bucketed_is_inverse_of_sub_diff_test_bucketed_task_inst_id_to_task_seg_ids =
QCheck.Test.make ~count:5000 ~name:"qc_add_diff_bucketed_is_inverse_of_sub_diff_test_bucketed_task_inst_id_to_task_seg_ids"
QCheck.(pair task_inst_id_to_task_seg_ids task_inst_id_to_task_seg_ids)
(fun (old, x) -> 
let diff = Daypack_lib.Task_inst_id_map_utils.Int64_bucketed.diff_bucketed ~old x in
Daypack_lib.Task_inst_id_map.equal Daypack_lib.Int64_set.equal (Daypack_lib.Task_inst_id_map_utils.Int64_bucketed.add_diff_bucketed diff (Daypack_lib.Task_inst_id_map_utils.Int64_bucketed.sub_diff_bucketed diff x)) x
)
let suite = [
