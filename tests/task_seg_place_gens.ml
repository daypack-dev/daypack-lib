...
let qc_single_task_seg_shift_consistent =
  QCheck.Test.make ~count:10_000 ~name:"qc_single_task_seg_shift_consistent"
    QCheck.(
...
let qc_single_task_seg_shift_sorted_and_uniq =
  QCheck.Test.make ~count:10_000
    ~name:"qc_single_task_seg_shift_sorted_and_uniq"
    QCheck.(
      triple nz_pos_int64 pos_int64
        (pair (pair task_seg_id small_pos_int64) tiny_sorted_time_slots))
    (fun (incre, cur_pos, ((task_seg_id, task_seg_size), time_slots)) ->
...
let qc_single_task_seg_shift_rev_consistent =
  QCheck.Test.make ~count:10_000 ~name:"qc_single_task_seg_shift_rev_consistent"
    QCheck.(
      triple nz_pos_int64 pos_int64
        (pair (pair task_seg_id small_pos_int64) tiny_sorted_time_slots))
...
let qc_single_task_seg_shift_rev_sorted_and_uniq =
  QCheck.Test.make ~count:10_000
    ~name:"qc_single_task_seg_shift_rev_sorted_and_uniq"
    QCheck.(
      triple nz_pos_int64 pos_int64
        (pair (pair task_seg_id small_pos_int64) tiny_sorted_time_slots))
    (fun (incre, cur_end_pos_exc, ((task_seg_id, task_seg_size), time_slots)) ->
...
let qc_multi_task_segs_shift_uniq =
  QCheck.Test.make ~count:1000 ~name:"qc_multi_task_segs_shift_uniq"
    ...
    (fun (incre, task_segs, time_slots) ->
       let time_slots = List.to_seq time_slots in
       let l =
         Daypack_lib.Task_seg_place_gens.multi_task_segs_shift ~incre ~task_segs
           time_slots
         |> List.of_seq
       in
...
let qc_single_task_seg_single_split_consistent =
  QCheck.Test.make ~count:1000
    ...
    (fun (min_seg_size, offset, cur_split_pos, task_seg) ->
       ...
       Daypack_lib.Task_seg_place_gens.single_task_seg_single_split ~min_seg_size
         ~max_seg_size ~cur_split_pos ~task_seg
...
let qc_single_task_seg_multi_splits_exact_shift_consistent =
  QCheck.Test.make ~count:1000
    ~name:"qc_single_task_seg_multi_splits_exact_shift_consistent"
    QCheck.(
      quad nz_pos_int64
...
let qc_single_task_seg_multi_splits_max_shift_consistent =
  QCheck.Test.make ~count:1000
    ~name:"qc_single_task_seg_multi_splits_max_shift_consistent"
    QCheck.(
      quad nz_pos_int64
        (triple nz_pos_int64 bool nz_pos_int64)
        small_pos_int64
...
let suite =
  [
    qc_single_task_seg_shift_consistent;
    qc_single_task_seg_shift_sorted_and_uniq;
    qc_single_task_seg_shift_rev_consistent;
    qc_single_task_seg_shift_rev_sorted_and_uniq;
    qc_multi_task_segs_shift_uniq;
    qc_single_task_seg_single_split_consistent;
    qc_single_task_seg_multi_splits_exact_consistent;
    qc_single_task_seg_multi_splits_max_consistent;
    qc_single_task_seg_multi_splits_exact_shift_consistent;
    qc_single_task_seg_multi_splits_max_shift_consistent;
  ]
