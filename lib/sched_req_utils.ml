let sched_req_template_matches_sched_req_data_unit
  ...
  | ( Sched_req_data_unit_skeleton.Shift (sizes1, time_slots1),
      Sched_req_data_unit_skeleton.Shift (task_segs, time_slots2) )
  | ( Sched_req_data_unit_skeleton.Time_share (sizes1, time_slots1),
      Sched_req_data_unit_skeleton.Time_share (task_segs, time_slots2) ) ->
  ...
  | ( Sched_req_data_unit_skeleton.Split_and_shift (size1, time_slots1),
      Sched_req_data_unit_skeleton.Split_and_shift ((_id, size2), time_slots2) )
    ->
