...
let sched_req_template_matches_sched_req_record
    (sched_req_template : Task.sched_req_template)
    ((_sched_req_record_id, sched_req_record_data) : Sched_req.sched_req_record) : bool =
  sched_req_template_matches_sched_req_record_data sched_req_template sched_req_record_data
