...
module Task_seg : sig
  ...
  val find_task_seg_ids_uncompleted_by_task_inst_id :
    Task_ds.task_inst_id -> sched -> Task_ds.task_seg_id Seq.t

  val find_task_seg_ids_completed_by_task_inst_id :
    Task_ds.task_inst_id -> sched -> Task_ds.task_seg_id Seq.t

  val find_task_seg_ids_discarded_by_task_inst_id :
    Task_ds.task_inst_id -> sched -> Task_ds.task_seg_id Seq.t

  val find_task_seg_ids_any_by_task_inst_id :
    Task_ds.task_inst_id -> sched -> Task_ds.task_seg_id Seq.t
  ...
  val find_task_seg_ids_uncompleted_by_task_id :
    Task_ds.task_id -> sched -> Task_ds.task_seg_id Seq.t

  val find_task_seg_ids_completed_by_task_id :
    Task_ds.task_id -> sched -> Task_ds.task_seg_id Seq.t

  val find_task_seg_ids_discarded_by_task_id :
    Task_ds.task_id -> sched -> Task_ds.task_seg_id Seq.t

  val find_task_seg_ids_any_by_task_id :
    Task_ds.task_id -> sched -> Task_ds.task_seg_id Seq.t
