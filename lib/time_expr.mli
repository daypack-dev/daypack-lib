...
module Interpret_string : sig
  ...
  val time_point_expr_of_string : string -> (Time_expr_ast.time_point_expr, string) result

  val time_slots_expr_of_string : string -> (Time_expr_ast.time_slots_expr, string) result
end
