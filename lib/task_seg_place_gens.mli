...
val multi_task_segs_shift :
  incre:int64 ->
  task_segs:Task_ds.task_seg list ->
  Time_slot_ds.t Seq.t ->
...
val single_task_seg_single_split :
  ...
  cur_split_pos:int64 ->
  task_seg:Task_ds.task_seg ->
  (Task_ds.task_seg * Task_ds.task_seg) Seq.t
...
val single_task_seg_multi_even_splits :
  incre:int64 ->
  task_seg:Task_ds.task_seg ->
  buckets:Time_slot_ds.t list ->
  usable_time_slots:Time_slot_ds.t Seq.t ->
  Task_ds.task_seg_place list Seq.t
