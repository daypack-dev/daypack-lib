  ...
  let matching_unix_seconds ~(force_bound : Time_expr_ast.bound option)
    ...
    | Ok pat -> (
        ...
        | Ok e -> (
            ...
            in
            match
              Time_pattern.Single_pattern.matching_time_slots ~allow_search_param_override:true search_param pat
            with
    ...
    | Ok e -> (
        ...
        | Ok l -> (
            match
              ...
              .matching_time_slots_round_robin_non_decreasing ~allow_search_param_override:true search_param l
            with
            | Error e -> Error (Time_pattern.To_string.string_of_error e)
            | Ok s ->
              s
  ...
  let rec aux e =
    ...
    | Time_unary_op (op, e) -> (
        ...
        | Ok not_mem_of -> (
            ...
            | Not -> (
                match
                  Time_pattern.Single_pattern.matching_time_slots ~allow_search_param_override:true search_param
                    Time_pattern.empty
                with
